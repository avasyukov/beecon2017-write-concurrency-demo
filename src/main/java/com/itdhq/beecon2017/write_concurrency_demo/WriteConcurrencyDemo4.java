 ...
 * 
 */
public class WriteConcurrencyDemo4 extends DeclarativeWebScript {
    private static final Log logger = LogFactory.getLog(WriteConcurrencyDemo4.class);
    ...
    protected String targetFolderName = "WRITE_CONCURRENCY_DEMO_4";
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        // Injected custom helper
        NodeRef folderRef = retryingTransactionHelper.doInTransaction(
