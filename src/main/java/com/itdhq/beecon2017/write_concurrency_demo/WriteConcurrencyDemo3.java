 ...
 * 
 */
public class WriteConcurrencyDemo3 extends DeclarativeWebScript {
    private static final Log logger = LogFactory.getLog(WriteConcurrencyDemo3.class);
    protected ServiceRegistry serviceRegistry;
    protected NodeService nodeService;
    protected Repository repositoryHelper;
    
    // Hardcoded names for demo, determined on the fly in real life
    protected String targetFolderName = "WRITE_CONCURRENCY_DEMO_3";
                ...
                public NodeRef execute() throws Throwable {
                    ...
                    if(assocs.isEmpty()) {
                        ...
                        try {
                            ...
                            logger.info("Manual exception handling");
                            targetFolderRef = nodeService.getChildAssocs(
                                    rootFolderRef, ContentModel.ASSOC_CONTAINS, targetFolderQName).get(0).getChildRef();
                        }
                    } else {
