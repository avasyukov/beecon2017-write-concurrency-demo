 ...
 * 
 */
public class WriteConcurrencyDemo1 extends DeclarativeWebScript {
    private static final Log logger = LogFactory.getLog(WriteConcurrencyDemo1.class);
    protected ServiceRegistry serviceRegistry;
    protected NodeService nodeService;
    protected Repository repositoryHelper;
    
    // Hardcoded names for demo, determined on the fly in real life
    protected String targetFolderName = "WRITE_CONCURRENCY_DEMO_1";
    ...
    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
        ...
        model.put("folderRef", targetFolderRef.toString());
